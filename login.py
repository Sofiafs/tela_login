...
class TelaLogin(BoxLayout):
    def __init__ (self, **kwargs):
        ...
        self.login_button= Button(text='E N T R A R', color=(0, 0, 0.1, 1), size_hint=(None, None), size=(450, 50),background_color =(100, 100, 100, 100))
        self.login_button.bind(on_press=self.login)
        self.signup_button= Button(text='C A D A S T R E - S E', color=(0, 0, 0.1, 1), size_hint=(None,None), size=(450, 50),background_color =(100, 100, 100, 100))
...
class TelaCadastro(BoxLayout):
    def __init__ (self, **kwargs):
        ...
        self.buttons_layout= BoxLayout(padding=[0, 10], spacing=10)
        self.signup_button= Button(text='C A D A S T R E - S E', color=(0, 0, 0.1, 1), size_hint=(None,None), size=(900, 50),background_color =(100, 100, 100, 100))
